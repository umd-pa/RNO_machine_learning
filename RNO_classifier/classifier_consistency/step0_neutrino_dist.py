...
# This is now provided via the --base-dir command line argument.
...
def run_veff(n_jobs, start_index, base_dir):
    step_dir = os.path.join(base_dir, "classifier_consistency", "neutrinos", "veff")
    tasks = []
...
def run_nu(n_jobs, start_index, base_dir):
    cfg     = NU_CONFIG
    out_dir = os.path.join(base_dir, "classifier_consistency", "neutrinos", "nu")
    os.makedirs(out_dir, exist_ok=True)
...
def run_noise(n_jobs, start_index, base_dir):
    cfg     = NOISE_CONFIG
    out_dir = os.path.join(base_dir, "classifier_consistency", "neutrinos", "noise")
    os.makedirs(out_dir, exist_ok=True)
